...
import com.porfolio.Dai.Dto.dtoExperiencia;
import com.porfolio.Dai.Entity.Experiencia;
import com.porfolio.Dai.Security.Controller.Mensaje;
import com.porfolio.Dai.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        ...
        if(StringUtils.isBlank(dtoexp.getNombreE()))
            return new ResponseEntity(new Mensaje("El mobre es oblogatorio"), HttpStatus.BAD_REQUEST);
